package com.enzenith.common.ueditor;

import com.enzenith.common.ueditor.define.ActionMap;
...
public final class ConfigManager {
	...
	private void initEnv () throws FileNotFoundException, IOException {
		...
		//更改获取配置文件的方式
//		String configPath1 = ResourceUtils.getFile("classpath:config.json").getAbsolutePath();
		InputStream config = this.getClass().getClassLoader().getResourceAsStream("config.json");
		String configContent =  this.readFile( config );
