package com.enzenith.utils.httpclient;

import com.enzenith.utils.httpclient.builder.HCB;
import com.enzenith.utils.httpclient.common.HttpConfig;
import com.enzenith.utils.httpclient.common.HttpMethods;
import com.enzenith.utils.httpclient.common.HttpResult;
 ...
 *   
 * @author: jikunle
 * @date:   2018年11月1日 下午2:42:30 
 */ 
public class HttpClientUtil{

	private final static String STRING_HTTPS = "https://";
	...
	private static void create(HttpConfig config) throws HttpProcessException  {
		...
		if(config.client()==null){
			if(config.url().toLowerCase().startsWith(STRING_HTTPS)){
