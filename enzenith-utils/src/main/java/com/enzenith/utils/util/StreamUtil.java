...
public final class StreamUtil {
     ...
     */
    public final static byte[] streamToByte(InputStream is) throws IOException {
     ...
     */
    public final static byte[] inputStreamToByte(InputStream inStream) throws Exception {
        int count = 0;
        while (count == 0) {
     ...
     */
    public final static InputStream byteToInputStream(byte[] b) throws Exception {
