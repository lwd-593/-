...
public final class RsaUtil {
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        ...
        PrivateKey privateKe = keyFactory.generatePrivate(pkcs8KeySpec);
        Signature signature = Signature.getInstance(SIGNATURE_ALGORITHM);
        signature.initSign(privateKe);
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
        ...
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
        Key privateKe = keyFactory.generatePrivate(pkcs8KeySpec);
    ...
    public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey) throws Exception {
        ...
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
        Key publicKe = keyFactory.generatePublic(x509KeySpec);
        Cipher cipher = Cipher.getInstance(keyFactory.getAlgorithm());
    ...
    public static String decryptDataWithPubKey(String data, String publicKey) throws Exception {
        ...
        return new String(decryptByPublicKey(rs, publicKey), UtilsConstant.UTF_8);
    }
    ...
    public static String decryptDataWithPriKey(String data, String privateKey) throws Exception {
        byte[] rs = decryptBASE64(data);
        return new String(decryptByPrivateKey(rs, privateKey), UtilsConstant.UTF_8);
    }
