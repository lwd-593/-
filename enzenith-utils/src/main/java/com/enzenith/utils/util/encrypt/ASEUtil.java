...
public final class ASEUtil {
    ...
    public static String AESEncode(String encodeRules, String content) {
        try {
            ...
            byte[] byteEncode = content.getBytes(UtilsConstant.UTF_8);
            ...
            // Library，重新编译后就一切正常了。
            //11.将字符串返回
            return new String(Base64Ext.encode(byteAes, Base64Ext.NO_WRAP));
    ...
    public static String AESDncode(final String encodeRules, String content) {
        try {
            ...
            // 8.将加密并编码后的内容解码成字节数组
            byte[] byteContent = Base64Ext.decode(content.getBytes(), Base64Ext.NO_WRAP);
            /*
             * 解密
			 */
            byte[] byteDecode = cipher.doFinal(byteContent);
            return new String(byteDecode, UtilsConstant.UTF_8);
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
