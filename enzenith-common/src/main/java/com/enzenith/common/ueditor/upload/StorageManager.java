...
public class StorageManager {
	...
	public static State saveFileByInputStream(HttpServletRequest request, MultipartFile file, String path, String picName,
											  long maxSize) {
...
//			UploadResult result = baseFileService.upload(dataBuf, picName, "OM", null);
			...
			String jsonStr= HttpFileUtils.makeFileJsonStr(file,newFileName);
			String httpRes= HttpFileUtils.httpPost(jsonStr);
			String filePath= HttpFileUtils.getFilePath(httpRes,newFileName);

			boolean success = true;
//			String url = path + "/" + picName;
			//如果上传成功
			if (success) {
