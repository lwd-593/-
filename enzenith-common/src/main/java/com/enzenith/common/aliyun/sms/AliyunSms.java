package com.enzenith.common.aliyun.sms;
...
public class AliyunSms {
     ...
     * @return: boolean
     * @author: LinShupeng
     * @date: 2019-11-12  下午 5:20
     **/
    public static boolean send(String phoneNumber, String content, String accessKeyId, String accessKeySecret,
                               String signName, String templateCode) throws ClientException, JSONException {
        //设置超时时间-可自行调整
