...
public class Utils {
	...
	private final static String STRING_EQUAL_SIGN = "=";
	/**
	 * 是否开启debug，
	 */
	...
	public static String checkHasParas(String url, List<NameValuePair> nvps, String encoding) throws UnsupportedEncodingException {
		// 检测url中是否存在参数
		if (url.contains(STRING_QUESTION_MARK) && url.indexOf(STRING_QUESTION_MARK) < url.indexOf(STRING_EQUAL_SIGN)) {
