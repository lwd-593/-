...
import com.enzenith.utils.algorithm.impl.FileTypeImpl;
...
public final class FileUtil {
    ...
    public static String multipartFileToBase64(MultipartFile file) {
        ...
        try {
            ...
            //Base64编码
            base64Str = encoder.encodeBuffer(bytes);
     ...
     * @throws IOException
     */
    public static File base64ToFile(String fileName, String base64Str) throws IOException {
     ...
     * @version V1.0
     * @author: jikunle
     * @date:   2018年12月6日 上午11:17:38
     */
    public static String byteToBase64(byte[] fileByte) {
        String base64Str = null;
        BASE64Encoder encoder = new BASE64Encoder();
        //Base64编码
        base64Str = encoder.encodeBuffer(fileByte);
        return base64Str;
    }
    ...
    private static File getNewFile(String fileName) throws IOException {
        ...
        File newFile = new File(uploadDir+newFileName + "." + suffix);
        return newFile;
    }
     ...
     * @version V1.0
     * @author: jikunle
     * @date:   2018年10月7日 下午4:45:25
     */
    private static String getFilePath() throws IOException{
        InputStream in = FileUtil.class.getClassLoader().getResourceAsStream("resource/resource.properties");
        Properties p = new Properties();
        p.load(in);
        String uploadDir = p.getProperty("FILE_PATH");
        return uploadDir;
    }
}