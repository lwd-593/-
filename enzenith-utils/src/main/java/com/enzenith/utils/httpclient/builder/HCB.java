package com.enzenith.utils.httpclient.builder;

import com.enzenith.utils.httpclient.common.SSLs;
import com.enzenith.utils.httpclient.common.SSLs.SSLProtocolVersion;
...
public class  HCB extends HttpClientBuilder{
	...
	public HCB pool(int maxTotal, int defaultMaxPerRoute) throws HttpProcessException{
		...
		// Increase max connections for $route(eg：localhost:80) to 50
		isSetPool=true;
